...
public static class BuiltInMemberCollections
{
	...
	/// </summary>
	public static SortedDictionary<String, UnaryOperatorClasses> UnaryOperators { get; } = new() { { "+", new(new BlockStackComparer()) { { new([new(BlockType.Interface, "INumber", 1)]), new() { (false, (new([new(BlockType.Extra, "T", 1)]), NoBranches), (new([new(BlockType.Interface, "INumber", 1)]), BranchCollectionT)) } } } }, { "-", new(new BlockStackComparer()) { { new([new(BlockType.Interface, "ISignedIntegerNumber", 1)]), new() { (false, (new([new(BlockType.Extra, "T", 1)]), NoBranches), (new([new(BlockType.Interface, "ISignedIntegerNumber", 1)]), BranchCollectionT)) } }, { new([new(BlockType.Interface, "IRealNumber", 1)]), new() { (false, (new([new(BlockType.Extra, "T", 1)]), NoBranches), (new([new(BlockType.Interface, "IRealNumber", 1)]), BranchCollectionT)) } } } }/*, { "++", new(new BlockStackComparer()){ { "IBase", new() { (false, new(new Block[]{ new(BlockType.Extra, "T", 1) }), NoBranches, "IBase", BranchCollectionT), (true, new(new Block[]{ new(BlockType.Extra, "T", 1) }), NoBranches, "IBase", BranchCollectionT) } } } }, { "--", new(new BlockStackComparer()){ { "IBase", new() { (false, new(new Block[]{ new(BlockType.Extra, "T", 1) }), NoBranches, "IBase", BranchCollectionT), (true, new(new Block[]{ new(BlockType.Extra, "T", 1) }), NoBranches, "IBase", BranchCollectionT) } } } }*/, { "!", new(new BlockStackComparer()) { { ExtendedTypeBool, new() { (false, (ExtendedTypeBool, NoBranches), (ExtendedTypeBool, NoBranches)) } } } }/*, { "!!", new(new BlockStackComparer()){ { GetPrimitiveBlockStack("bool"), new() { (true, GetPrimitiveBlockStack("bool"), NoBranches, GetPrimitiveBlockStack("bool"), NoBranches) } } } }*/, { "~", new(new BlockStackComparer()) { { new([new(BlockType.Interface, "ISignedIntegerNumber", 1)]), new() { (false, (new([new(BlockType.Extra, "T", 1)]), NoBranches), (new([new(BlockType.Interface, "ISignedIntegerNumber", 1)]), BranchCollectionT)) } } } } };
	...
	public static G.SortedSet<(String Namespace, String Type)> NotImplementedTypes { get; } = [([], "complex"), ([], "long complex"), ([], "long long"), ([], "long real"), ("System", "Delegate"), ("System", "Enum"), ("System", "Environment"), ("System", "OperatingSystem")];
