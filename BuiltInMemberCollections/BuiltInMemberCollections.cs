...
public static class BuiltInMemberCollections
{
	...
	/// </summary>
	public static ExtendedTypesCollection ExtendedTypes { get; } = new(new BlockStackAndStringComparer()) { { (new([new(BlockType.Namespace, "System", 1)]), nameof(Action)), ([new(true, NoBranches, GetPrimitiveBlockStack("typename"), "Types")], TypeAttributes.Delegate) }, { (new([new(BlockType.Namespace, "System", 1)]), nameof(Func<bool>)), new([new(false, NoBranches, GetPrimitiveBlockStack("typename"), "TReturn"), new(true, NoBranches, GetPrimitiveBlockStack("typename"), "Types")], TypeAttributes.Delegate) } };
	...
	/// <summary>
	/// Sorted by Name, also contains ExtraTypes, ReturnType, ReturnNStarType.ExtraTypes, Attributes, ParameterTypes, ParameterNames, ParameterExtraTypes, ParameterAttributes and ParameterDefaultValues.
	/// </summary>
