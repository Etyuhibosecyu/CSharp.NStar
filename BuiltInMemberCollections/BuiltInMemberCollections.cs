...
public static class BuiltInMemberCollections
{
	...
	public static SortedSet<String> Namespaces { get; } = new("System", "System.Collections");
	...
	/// </summary>
	public static TypeSortedList<ExtendedMethods> ExtendedMethods { get; } = new() { { new(), new() { { "ExecuteString", new() { new([], (new([new(BlockType.Primitive, "universal", 1)]), NoBranches), FunctionAttributes.Multiconst, [ExtendedParameterStringS, new(new(new([new(BlockType.Primitive, "universal", 1)]), NoBranches), "parameters", ParameterAttributes.Params, [])]) } } } } };
	...
	/// </summary>
	public static List<NStarType> ImplicitConversionsFromAnything { get; } = [(GetPrimitiveBlockStack("universal"), NoBranches), (GetPrimitiveBlockStack("null"), NoBranches), (ExtendedTypeList, [new("type", 0, []) { Extra = GetPrimitiveType("[this]") }])];
